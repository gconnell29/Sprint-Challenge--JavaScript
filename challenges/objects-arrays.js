...
const populationSum = (accumulator, currentValue) => accumulator + currentValue;
// populationTotal.reduce((acc, current) => acc + current);
console.log(populationTotal.reduce(populationSum, 0));
/*
